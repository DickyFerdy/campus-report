    ...
    <div class="dashboard-layout">
        ...
        <aside class="sidebar">
            ...
            <ul class="nav-menu">
                ...
                <li class="nav-item active"> <a href="#"><iconify-icon icon="lucide:activity" width="20"></iconify-icon> Status Laporan</a>
                </li>
                <li class="nav-item">
                    <a href="#"><iconify-icon icon="lucide:history" width="20"></iconify-icon> Riwayat</a>
                </li>
            </ul>
