    ...
    <div class="dashboard-layout">
        ...
        <aside class="sidebar">
            ...
            <ul class="nav-menu">
                ...
                <li class="nav-item active"><a href="status_laporan.php"><iconify-icon icon="lucide:activity" width="20"></iconify-icon> Status Laporan</a></li>
