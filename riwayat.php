    ...
    <div class="dashboard-layout">
        ...
        <aside class="sidebar">
            ...
            <ul class="nav-menu">
                ...
                <li class="nav-item"><a href="status_laporan.php"><iconify-icon icon="lucide:activity" width="20"></iconify-icon> Status Laporan</a></li>
                <li class="nav-item active"><a href="riwayat.php"><iconify-icon icon="lucide:history" width="20"></iconify-icon> Riwayat</a></li>
            </ul>
        ...
        <main class="main-content">
            ...
            <header class="topbar">
                <div class="search-bar">
                    ...
                    <input type="text" placeholder="Cari global..." disabled>
                </div>
